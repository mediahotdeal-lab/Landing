        ...
        <div className="mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <div className="inline-block mb-6">
              <span className="bg-red-50 text-red-600 px-4 py-2 rounded-full text-sm font-semibold">
                #1 Digital Marketing Agency Vietnam
              </span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-6 leading-tight">
              Giải Pháp Marketing
              <br />
              <span className="text-red-600">Tăng Trưởng Doanh Thu</span>
              <br />
              Vượt Bậc
            </h1>
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Chúng tôi giúp doanh nghiệp của bạn tiếp cận đúng khách hàng, tăng doanh số bán hàng và xây dựng thương hiệu mạnh mẽ với các giải pháp Digital Marketing hiệu quả.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              >
                <span className="group-hover:translate-x-[-4px] transition-transform">Khám phá dịch vụ</span>
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto">
            <div className="group bg-white border border-gray-200 rounded-xl p-6 text-center hover:border-red-600 transition-all hover:shadow-lg hover:scale-105">
              ...
              <div className="text-sm sm:text-base text-gray-600 font-medium">Dự án hoàn thành</div>
            </div>
            <div className="group bg-white border border-gray-200 rounded-xl p-6 text-center hover:border-red-600 transition-all hover:shadow-lg hover:scale-105">
            ...
            <div className="group bg-white border border-gray-200 rounded-xl p-6 text-center hover:border-red-600 transition-all hover:shadow-lg hover:scale-105">
              ...
              <div className="text-sm sm:text-base text-gray-600 font-medium">ROI trung bình</div>
            </div>
          </div>
        </div>
      </div>
