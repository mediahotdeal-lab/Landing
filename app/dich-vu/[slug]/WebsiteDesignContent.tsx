...
export default function WebsiteDesignContent() {
  const t = useTranslations('serviceDetailPage.websiteDesign');
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="w-full md:w-[90%] max-w-[1440px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mt-8 sm:mt-12">
            {features.items.map((item, index) => {
              const icons = [
                ...
                <svg key={index} className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>,
